...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i17.ChildFormBloc>(
        () => _i17.ChildFormBloc(gh<_i15.IRelationRepository>()));
    gh.factory<_i18.RelationWatcherBloc>(
        () => _i18.RelationWatcherBloc(gh<_i15.IRelationRepository>()));
    gh.factory<_i19.PartnerFormBloc>(
        () => _i19.PartnerFormBloc(gh<_i15.IRelationRepository>()));
    gh.lazySingleton<_i20.IUserRepository>(
        () => _i21.UserRepository(gh<_i8.FirebaseFirestore>()));
    gh.factory<_i22.TreeFormBloc>(
        () => _i22.TreeFormBloc(gh<_i9.ITreeRepository>()));
    gh.factory<_i23.TreeActorBloc>(
        () => _i23.TreeActorBloc(gh<_i9.ITreeRepository>()));
    gh.factory<_i24.TreeWatcherBloc>(
        () => _i24.TreeWatcherBloc(gh<_i9.ITreeRepository>()));
    gh.factory<_i25.NodeActorBloc>(
        () => _i25.NodeActorBloc(gh<_i13.INodeRepository>()));
    gh.factory<_i26.NodeFormBloc>(
        () => _i26.NodeFormBloc(gh<_i13.INodeRepository>()));
    gh.factory<_i27.FamilyWatcherBloc>(
        () => _i27.FamilyWatcherBloc(gh<_i13.INodeRepository>()));
    gh.factory<_i28.NodeWatcherBloc>(
        () => _i28.NodeWatcherBloc(gh<_i13.INodeRepository>()));
