...
abstract class $TNodeCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {UniqueId treeId, UniqueId nodeId, FirstName firstName, DateTime? date});
}
...
class _$TNodeImpl extends _TNode {
  ...
  @override
  String toString() {
    return 'TNode(treeId: $treeId, nodeId: $nodeId, firstName: $firstName, date: $date)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, treeId, nodeId, firstName, date);
...
abstract class _TNode extends TNode {
  const factory _TNode(
      ...
      final DateTime? date}) = _$TNodeImpl;
