          ...
          child: Column(children: [
            ...
            MaterialButton(
                ...
                onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const GraphClusterViewPage(),
                      ),
                    ),
                child: const Text(
            ...
            MaterialButton(
                ...
                onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const LayeredGraphViewPage(),
                      ),
                    ),
                child: const Text(
            ...
            MaterialButton(
                ...
                onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const TreeViewPageFromJson(),
                      ),
                    ),
                child: const Text(
            ...
            MaterialButton(
                ...
                onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const LayerGraphPageFromJson(),
                      ),
                    ),
                child: const Text(
